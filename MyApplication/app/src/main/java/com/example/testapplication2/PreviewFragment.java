...
public class PreviewFragment extends Fragment {
        ...
        private void process(CaptureResult result){
            switch (mState){
                ...
                case STATE_WAITING_LOCK:{
                    ...
                    if (afState == null)    captureStillPicture();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        surfaceTextureView = view.findViewById(R.id.surface_texture_view);
    }
    ...
    public void onResume() {
        ...
        if (surfaceTextureView.isAvailable()){
            openCamera(surfaceTextureView.getWidth(),surfaceTextureView.getHeight());
        }else
...
//    创建可视化视图
    private void creatCameraPreviewSession(){
        try {
            SurfaceTexture texture = surfaceTextureView.getSurfaceTexture();
            assert  texture != null;

            texture.setDefaultBufferSize(surfaceTextureView.getWidth(),surfaceTextureView.getHeight());
